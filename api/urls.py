...
urlpatterns = [
    ...
    path('quotes/archive', views_quote.QuoteArchive.as_view()),
    ...
    path('projects/archive', views_project.ProjectArchive.as_view()),
    ...
    path('services/archive', views_project.ServiceArchive.as_view()),
    ...
    path('hses/archive', views_project.HSEArchive.as_view()),
