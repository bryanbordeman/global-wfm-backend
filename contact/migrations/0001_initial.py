    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ManyToManyField(blank=True, to='contact.address')),
            ],
        ),
        migrations.CreateModel(
            name='Phone',
            fields=[
                ...
                ('phone_type', models.CharField(choices=[('Mobile', 'Mobile'), ('Work', 'Work'), ('Home', 'Home')], default='Mobile', max_length=200, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Contact',
